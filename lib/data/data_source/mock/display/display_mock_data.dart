class DisplayMockData {
  ...
  static final String productInfo7 = '''{
        "productId": "${DateTime.now().microsecondsSinceEpoch}",
        "title":"[아랑Pick] VT 리들샷 100 에센스 50ml 기획/단품",
        "subtitle":"탱글한 입술을 위한 최고의 아이템",
        "price": 14400,
        "originalPrice": 16000,
        "discountRate": 20,
  ...
  static final String productInfo8 = '''{
        "productId": "${DateTime.now().microsecondsSinceEpoch}",
        "title":"에스네이처 아쿠아 스쿠알란 수분크림 60ml 더블 기획 (+카밍패드 2매)",
        "subtitle":"탱글한 입술을 위한 최고의 아이템",
        "price": 12300,
        "originalPrice": 15000,
        "discountRate": 20,
  ...
  static final String productInfo9 = '''{
        "productId": "${DateTime.now().microsecondsSinceEpoch}",
        "title":"바이오더마 하이드라비오 토너 500ml 기획 (+양면 토너패드 50매)",
        "subtitle":"탱글한 입술을 위한 최고의 아이템",
        "price": 14400,
        "originalPrice": 16000,
        "discountRate": 20,
  ...
  static final String productInfo11 = '''{
        "productId": "${DateTime.now().microsecondsSinceEpoch}",
        "title":"퓌 립앤치크 블러리 푸딩팟 증정 기획(+팬던트키링)",
        "subtitle":"탱글한 입술을 위한 최고의 아이템",
        "price": 20000,
        "originalPrice": 25000,
        "discountRate": 20,
