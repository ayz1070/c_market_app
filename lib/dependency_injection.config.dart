...
import 'package:c_market_app/data/data_source/data_source_module.dart' as _i20;
...
import 'package:c_market_app/domain/usecase/display/notifications/fetch_notifications.dart'
    as _i18;
import 'package:c_market_app/firebase_module.dart' as _i21;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i11.NotificationDataSource>(
        () => _i11.NotificationDataSource(
              gh<_i9.FirebaseFirestore>(),
              gh<_i12.FirebaseStorage>(),
            ));
    gh.lazySingleton<_i13.NotificationRepository>(() =>
        _i14.NotificationRepositoryImpl(gh<_i11.NotificationDataSource>()));
    gh.factory<_i15.PaymentBloc>(() => _i15.PaymentBloc());
    gh.factory<_i16.ViewModuleBloc>(
        () => _i16.ViewModuleBloc(gh<_i8.DisplayUsecase>()));
    gh.factory<_i17.CartListBloc>(
        () => _i17.CartListBloc(gh<_i8.DisplayUsecase>()));
    gh.lazySingleton<_i18.FetchNotifications>(
        () => _i18.FetchNotifications(gh<_i13.NotificationRepository>()));
    gh.factory<_i19.NotificationBloc>(
        () => _i19.NotificationBloc(gh<_i18.FetchNotifications>()));
    return this;
  }
}
